        ...
        <div className="nav-actions">
          {status === "loading" ? (
            ...
            <>
              <Link
                href="/user/search"
                className="searchBar block icon-btn relative cursor-pointer"
              >
                ...
                <input
                  id="member_email"
                  className="formkit-input cursor-pointer bg-slate-50 border border-[#FDCF93] text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-3 p-2.5 "
                  name="email_address"
              ...
              {isAdmin && (
                <Link href="/admin/dashboard" className="icon-btn">
                  ...
                  >
                    ...
                    <g id="SVGRepo_iconCarrier">
                      <path
                        d="M510.5 958.5c247.2 0 447.5-200.4 447.5-447.5S757.7 63.5 510.5 63.5 63 263.8 63 511s200.4 447.5 447.5 447.5z"
                        fill="#1C274C"
                      ></path>
                      <path
                        d="M510.5 902.6c-216.3 0-391.6-175.3-391.6-391.6S294.2 119.4 510.5 119.4s391.6 175.3 391.6 391.6-175.3 391.6-391.6 391.6z"
                        fill="#FFFFFF"
                      ></path>
                      <path
                        d="M405.8 558.9h-2c-31 0-43-21.4-27-47.8L524 269.2c33.5-55.1 44.2-50.2 24 11l-45.1 136.1c-9.7 29.4 7.5 52.9 38.4 52.9H628l-0.4 0.4h2c31 0 43 21.4 27 47.8L515.7 749c-36.9 60.7-48.8 55.3-26.4-12.3l41.3-124.5c9.7-29.4-7.5-52.9-38.4-52.9h-86.7l0.3-0.4z"
                        fill="#1C274C"
                      ></path>
                    </g>
                  </svg>
