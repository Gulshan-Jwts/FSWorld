    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <ul>
            <li>
              <Link href="/policies/guidelines">All Guidelines</Link>
            </li>
            <li>
        ...
        <div className="footer-section">
          ...
          <p>
            Stay in the loop with exclusive offers and the latest fashion
            updates.
          </p>
          <form className="newsletter-form">
            ...
            <button
              ...
              onClick={(e) => {
                e.preventDefault();
                setInput("");
                toast.success("Thank your for joining us", {
                  position: "top-right",
                  autoClose: 3000,
      ...
      <div className="footer-bottom">
        <p>© 2025 TMH. Crafted with Elegance.</p>
      </div>
    </footer>
  );
};
